...
@objc public protocol NAExpandableTableViewDataSource {
    ...
    @objc optional func expandableTableView(_ tableView: UITableView, heightForRowInSection section: Int) -> CGFloat
...
open class NAExpandableTableController: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let rowIndexPath = expandable ? IndexPath(row: indexPath.row - 1, section: indexPath.section) : indexPath
    ...
    open func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 && expandable {
            ...
            let rowIndexPath = IndexPath(row: indexPath.row - 1, section: indexPath.section)
