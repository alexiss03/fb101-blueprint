...
protocol NYSpreadheetFormatTemplateViewDelegate {
    func setUpComputations()

}


class NYSpreadheetFormatTemplateView: NYBaseSpreadsheetView {
    
    var delegate: NYSpreadheetFormatTemplateViewDelegate?
    ...
    @IBOutlet weak var r1TField1: UITextField!
    @IBOutlet weak var r1TField2: UITextField!
    ...
    @IBOutlet weak var r20Lbl1: NYLabel!
    @IBOutlet weak var r20Lbl2: NYLabel!
