...
class NYRPPensionFundViewController:
    NYRPBaseViewController {
    
    override func viewDidLoad() {
        
        formId = "NYRPPF"
        formName = "Retirement Planning Pension Funding" 
        
        
        v = NYRPPensionFundView.fromNib("NYRPPensionFundView")
    ...
    override func setUpFieldIds() {
        ...
        v!.r15Lbl2.preloadedVal =  "Future Retirement Pension Required @"
    }
